...
import { fetchTenantPayments } from "../actions";
...
export function PaymentList() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    ...
    queryFn: () => fetchTenantPayments({ page, limit: 10 }),
  });
    ...
    <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-xl backdrop-blur-md">
      ...
      <div className="border-b border-slate-800 pb-5">
        ...
        <p className="mt-1 text-xs text-slate-400">
          History of all your rental transactions and payments.
        </p>
      </div>
      ...
      <div className="mt-6">
        {isLoading ? (
          ...
          <div className="rounded-xl border border-red-500/20 bg-red-500/10 p-6 text-center">
            <p className="text-xs text-red-400">Failed to load payment history.</p>
            <button
              onClick={() => refetch()}
          ...
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-800 bg-slate-900/40 py-10 text-center">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Once a landlord approves your request and you make a payment, it will appear here.
            </p>
          </div>
        ) : (
